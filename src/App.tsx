...
import './App.css';
//Alex Wirick Mission 12
//This is the App.tsx page, this is where everything is built and sent to the index.tsx file to be rendered
const teamNames = [
  {
    tid: 159,
    cid: 0,
...
function Welcome() {
  return (
    <h1>
      This is a site that shows all of the schools in the NCAA and information
      about them.
    </h1>
  );
}
